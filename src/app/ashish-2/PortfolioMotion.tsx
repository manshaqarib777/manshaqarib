...
/**
 * Scroll motion for the page, transcribed from the reference build.
 *
 ...
 * reference drives this: the sections stay server components with no client
...
export function PortfolioMotion() {
  ...
  useGSAP(
    () => {
      // The reference skips its scroll motion entirely under reduced motion —
      ...
      // The grid drifts and grows faster than the copy, which is what separates
      ...
      gsap.utils.toArray<HTMLElement>(".project").forEach((project) => {
        ...
        gsap.from(project.querySelectorAll(".metric, .project-brief > div"), {
          transform: "translate3d(0, 14px, 0)",
          duration: 0.5,
          ease: "power3.out",
          stagger: 0.055,
          scrollTrigger: {
            trigger: project.querySelector(".metric-row"),
            start: "top 84%",
          },
        });
      ...
      // pulling away, so the page closes rather than continuing.
      gsap.fromTo(
